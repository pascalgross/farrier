...
// editor's language server work off Linux, not so that the agent runs there. HostSeal ships no Windows
// or macOS agent, and cmd/hostseal-agent carries a build constraint that says so — this file only keeps
